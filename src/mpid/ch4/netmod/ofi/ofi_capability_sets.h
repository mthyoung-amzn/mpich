...
MPL_STATIC_INLINE_PREFIX int MPIDI_OFI_get_set_number(const char *set_name)
{
    ...
    } else if (!strcmp("efa", set_name)) {
        return MPIDI_OFI_SET_NUMBER_EFA;
...
/* EFA capability set */
#define MPIDI_OFI_ENABLE_DATA_EFA                   MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_AV_TABLE_EFA               MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS_EFA     MPIDI_OFI_OFF
#define MPIDI_OFI_MAX_ENDPOINTS_EFA                 MPIDI_OFI_MAX_ENDPOINTS_REGULAR
#define MPIDI_OFI_MAX_ENDPOINTS_BITS_EFA            MPIDI_OFI_MAX_ENDPOINTS_BITS_REGULAR
#define MPIDI_OFI_ENABLE_SHARED_CONTEXTS_EFA        MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_MR_VIRT_ADDRESS_EFA        MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_MR_ALLOCATED_EFA           MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_MR_PROV_KEY_EFA            MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_MR_REGISTER_NULL_EFA       MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_TAGGED_EFA                 MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_AM_EFA                     MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_RMA_EFA                    MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_ATOMICS_EFA                MPIDI_OFI_OFF
#define MPIDI_OFI_FETCH_ATOMIC_IOVECS_EFA           1
#define MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS_EFA     MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS_EFA  MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_PT2PT_NOPACK_EFA           MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_TRIGGERED_EFA              MPIDI_OFI_OFF
#define MPIDI_OFI_ENABLE_HMEM_EFA                   MPIDI_OFI_ON
#define MPIDI_OFI_NUM_AM_BUFFERS_EFA                MPIDI_OFI_MAX_NUM_AM_BUFFERS
#define MPIDI_OFI_NUM_OPTIMIZED_MEMORY_REGIONS_EFA  (0)
#define MPIDI_OFI_CONTEXT_BITS_EFA                  MPIDI_OFI_CONTEXT_BITS_a
#define MPIDI_OFI_SOURCE_BITS_EFA                   MPIDI_OFI_SOURCE_BITS_a
#define MPIDI_OFI_TAG_BITS_EFA                      MPIDI_OFI_TAG_BITS_a
#define MPIDI_OFI_COUNTER_WAIT_OBJECTS_EFA          MPIDI_OFI_OFF
#define MPIDI_OFI_MAJOR_VERSION_EFA                 1
#define MPIDI_OFI_MINOR_VERSION_EFA                 18

#ifdef MPIDI_CH4_OFI_USE_SET_EFA
#define MPIDI_OFI_PROV_NAME                     "efa"
#define MPIDI_OFI_SET_NUMBER                    MPIDI_OFI_SET_NUMBER_EFA
#define MPIDI_OFI_ENABLE_DATA                   MPIDI_OFI_ENABLE_DATA_EFA
#define MPIDI_OFI_ENABLE_AV_TABLE               MPIDI_OFI_ENABLE_AV_TABLE_EFA
#define MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS     MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS_EFA
#define MPIDI_OFI_MAX_ENDPOINTS                 MPIDI_OFI_MAX_ENDPOINTS_EFA
#define MPIDI_OFI_MAX_ENDPOINTS_BITS            MPIDI_OFI_MAX_ENDPOINTS_BITS_EFA
#define MPIDI_OFI_ENABLE_SHARED_CONTEXTS        MPIDI_OFI_global.settings.enable_shared_contexts
#define MPIDI_OFI_ENABLE_MR_VIRT_ADDRESS        MPIDI_OFI_ENABLE_MR_VIRT_ADDRESS_EFA
#define MPIDI_OFI_ENABLE_MR_ALLOCATED           MPIDI_OFI_ENABLE_MR_ALLOCATED_EFA
#define MPIDI_OFI_ENABLE_MR_PROV_KEY            MPIDI_OFI_ENABLE_MR_PROV_KEY_EFA
#define MPIDI_OFI_ENABLE_MR_REGISTER_NULL       MPIDI_OFI_ENABLE_MR_REGISTER_NULL_EFA
#define MPIDI_OFI_ENABLE_TAGGED                 MPIDI_OFI_ENABLE_TAGGED_EFA
#define MPIDI_OFI_ENABLE_AM                     MPIDI_OFI_ENABLE_AM_EFA
#define MPIDI_OFI_ENABLE_RMA                    MPIDI_OFI_ENABLE_RMA_EFA
#define MPIDI_OFI_ENABLE_ATOMICS                MPIDI_OFI_ENABLE_ATOMICS_EFA
#define MPIDI_OFI_FETCH_ATOMIC_IOVECS           MPIDI_OFI_FETCH_ATOMIC_IOVECS_EFA
#define MPIDI_OFI_IOVEC_ALIGN                   (1)
#define MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS     MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS_EFA
#define MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS  MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS_EFA
#define MPIDI_OFI_ENABLE_PT2PT_NOPACK           MPIDI_OFI_ENABLE_PT2PT_NOPACK_EFA
#define MPIDI_OFI_ENABLE_TRIGGERED              MPIDI_OFI_ENABLE_TRIGGERED_EFA
#define MPIDI_OFI_NUM_AM_BUFFERS                MPIDI_OFI_NUM_AM_BUFFERS_EFA
#define MPIDI_OFI_NUM_OPTIMIZED_MEMORY_REGIONS  MPIDI_OFI_NUM_OPTIMIZED_MEMORY_REGIONS_EFA
#define MPIDI_OFI_CONTEXT_BITS                  MPIDI_OFI_CONTEXT_BITS_EFA
#define MPIDI_OFI_SOURCE_BITS                   MPIDI_OFI_SOURCE_BITS_EFA
#define MPIDI_OFI_TAG_BITS                      MPIDI_OFI_TAG_BITS_EFA
#define MPIDI_OFI_COUNTER_WAIT_OBJECTS          MPIDI_OFI_COUNTER_WAIT_OBJECTS_EFA
#define MPIDI_OFI_MAJOR_VERSION                 MPIDI_OFI_MAJOR_VERSION_EFA
#define MPIDI_OFI_MINOR_VERSION                 MPIDI_OFI_MINOR_VERSION_EFA
#define MPIDI_OFI_CONTEXT_STRUCTS               2
#endif
