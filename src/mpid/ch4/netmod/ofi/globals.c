 ...
 * capability set at runtime */
{
    ...
    ,
    {   /* efa */
     .enable_data = MPIDI_OFI_ENABLE_DATA_EFA,
     .enable_av_table = MPIDI_OFI_ENABLE_AV_TABLE_EFA,
     .enable_scalable_endpoints = MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS_EFA,
     .enable_shared_contexts = MPIDI_OFI_ENABLE_SHARED_CONTEXTS_EFA,
     .enable_mr_virt_address = MPIDI_OFI_ENABLE_MR_VIRT_ADDRESS_EFA,
     .enable_mr_allocated = MPIDI_OFI_ENABLE_MR_ALLOCATED_EFA,
     .enable_mr_prov_key = MPIDI_OFI_ENABLE_MR_PROV_KEY_EFA,
     .enable_mr_register_null = MPIDI_OFI_ENABLE_MR_REGISTER_NULL_EFA,
     .enable_tagged = MPIDI_OFI_ENABLE_TAGGED_EFA,
     .enable_am = MPIDI_OFI_ENABLE_AM_EFA,
     .enable_rma = MPIDI_OFI_ENABLE_RMA_EFA,
     .enable_atomics = MPIDI_OFI_ENABLE_ATOMICS_EFA,
     .enable_data_auto_progress = MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS_EFA,
     .enable_control_auto_progress = MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS_EFA,
     .enable_pt2pt_nopack = MPIDI_OFI_ENABLE_PT2PT_NOPACK_EFA,
     .enable_hmem = MPIDI_OFI_ENABLE_HMEM_EFA,
     .enable_triggered = MPIDI_OFI_ENABLE_TRIGGERED_EFA,
     .num_am_buffers = MPIDI_OFI_NUM_AM_BUFFERS_EFA,
     .num_optimized_memory_regions = MPIDI_OFI_NUM_OPTIMIZED_MEMORY_REGIONS_EFA,
     .max_endpoints = MPIDI_OFI_MAX_ENDPOINTS_EFA,
     .max_endpoints_bits = MPIDI_OFI_MAX_ENDPOINTS_BITS_EFA,
     .fetch_atomic_iovecs = MPIDI_OFI_FETCH_ATOMIC_IOVECS_EFA,
     .context_bits = MPIDI_OFI_CONTEXT_BITS_EFA,
     .source_bits = MPIDI_OFI_SOURCE_BITS_EFA,
     .tag_bits = MPIDI_OFI_TAG_BITS_EFA,
     .counter_wait_objects = MPIDI_OFI_COUNTER_WAIT_OBJECTS_EFA,
     .major_version = MPIDI_OFI_MAJOR_VERSION_EFA,
     .minor_version = MPIDI_OFI_MINOR_VERSION_EFA}
};
